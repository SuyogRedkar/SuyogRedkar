...
- 🎓 MSc in Cloud Computing from National College of Ireland  
- 💼 Developer with hands-on experience in full-stack web apps, mobile development, and cloud-native systems  
- ☁️ Skilled in AWS (EC2, S3, Lambda, DynamoDB, CodePipeline, etc.)
- 🛠️ Languages & Tools:  
  `Python` `JavaScript` `Node.js` `React` `React Native` `Django` `Express.js`  
  `Docker` `GitHub Actions` `MySQL` `MongoDB` `Firebase` `Solidity`
